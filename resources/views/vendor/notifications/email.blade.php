...
<head>
    ...
    <title>Recuperación de Contraseña - Sindi PMK</title>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            ...
                            <div style="line-height: 35px">
                                ...
                                Recuperación <span style="color: #0080c5;">Contraseña</span>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px;margin-bottom:20px;">
                                            Has solicitado restablecer tu contraseña. Para asignar una nueva, haz clic en el siguiente enlace (o botón).
                                        </p>
                                        <table border="0" align="center" width="180" cellpadding="0" cellspacing="0" bgcolor="0080c5" style="margin-bottom:20px;">
                                            ...
                                            <tr>
                                                <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                                    ...
                                                    <div style="line-height: 22px;">
                                                        <a href="{{$actionUrl}}" style="color: #ffffff; text-decoration: none;">Recuperar Contraseña</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <p style="line-height: 15px; padding-bottom: 20px; font-size: 15px"><a href="{{$actionUrl}}">{{$actionUrl}}</a></p>

                                         <p style="line-height: 24px; padding-bottom: 20px">
                                            Si es un error y no solicitaste el restablecimiento, ignora este mensaje. Tu contraseña no cambiará. 
                                        </p>
        ...
        <tr>
            <td align="center" style="background-image: url(https://pmkblog.com/sindi/images/bgloginshort.jpg); background-size: cover; background-position: top center; background-repeat: no-repeat;"
                ...
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                ...
                                <tr>
                                    <td align="center">
                                        <table border="0" align="center" cellpadding="0" cellspacing="0" class="container580">
                                            <tr>
                                                <td align="center" style="color: #fff; font-size: 20px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;padding: 10px; background-color: rgba(86, 86, 86, .4);">
                                                    <!-- section text ======-->

                                                    <div style="line-height: 26px">

                                                        Ingresa al sistema Sindi.
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" align="center" width="250" cellpadding="0" cellspacing="0" style="border:2px solid #e4831d; background-color: #e4831d">
                                ...
                                <tr>
                                    <td align="center" style="color: #000000; font-size: 20px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                        <!-- main section button -->

                                        <div style="line-height: 22px;">
                                            <a href="" style="color: #fff; text-decoration: none;">Login Sindi</a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">Material PMK</span>
